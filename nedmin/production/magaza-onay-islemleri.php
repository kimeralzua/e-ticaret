  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Mağaza İnceleme Sayfası <small>,
          ...
          <div class="x_content">
            ...
            $zaman=explode(" ",$kullanicicek['kullanici_zaman']);
             ...
             ?>
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">İşyeri Tipi <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="kullanici_tip" id="first-name" name="kullanici_tip" disabled="" value="<?php echo $kullanicicek['kullanici_tip'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                <div id="kurumsal">
              <div class="form-group">
              ...
              <div id="tc" class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="tc" type="text" id="first-name" name="kullanici_tc" value="<?php echo $kullanicicek['kullanici_tc'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="kullanici_adres"   value="<?php echo $kullanicicek['kullanici_adres'] ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
             ...
             <div class="form-group">
              ...
              <button type="submit" name="magazaonaykayit" class="btn btn-success">Başvuryu Onayla</button>
                <a onclick="return confirm('Mağaza başvurusunu iptal etmek istiyor musunuz?')" class="btn btn-danger" href="../netting/adminislem.php?magazaonay=red&kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>">Başvuryu İptal Et</a>
