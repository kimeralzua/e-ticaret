...
// Başlangıç
			...
			//Kullanıcı kayıt işlemi yapılıyor...
				...
				header("Location:../../register?durum=varolankayit");
...
if (isset($_POST['musterigiris'])) {
	...
	if ($say==1) {
		...
		$_SESSION['userkullanici_id']=$kullanici_id;
...
if (isset($_POST['musterisifreguncelle'])) {
	...
	$kullanicisor=$db->prepare("SELECT * FROM kullanici where kullanici_password=:passwordd");
	$kullanicisor->execute(array(
	...
	if ($update) {
		...
		header("Location:../../sifre-guncelle?durum=sifreleruyusmadi");
	}
}
