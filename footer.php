                ...
                <div class="footer-area-top">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="footer-box">
                                    <h3 class="title-bar-left title-bar-footer">Kategoriler </h3>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="footer-box">
                                    <h3 class="title-bar-left title-bar-footer">Diğer Sayfalar</h3>
                                    <ul class="featured-links">
                                        <li>
                                            <ul>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="footer-box">
                                    <h3 class="title-bar-left title-bar-footer">Takip Et</h3>
