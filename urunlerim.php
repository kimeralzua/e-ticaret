...
?>
 ...
 <table class="table table-striped">
  ...
  <?php 
$urunsor=$db->prepare("SELECT * FROM urun where kullanici_id=:kullanici_id order by urun_zaman Asc");
...
while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) { $say++?>
    ...
    <tr>
      ...
      <?php }
       ...
       <a onclick="return confirm('Bu ürün kalıcı olarak silinecek. Emin misiniz?')" href="nedmin/netting/adminislem.php?urunsil=ok&urun_id=<?php echo $uruncek['urun_id'] ?>&urunfoto_resimyol=<?php echo $uruncek['urunfoto_resimyol'] ?>"><button class="btn btn-danger btn-xs">Mağzadan Sil</button></a>
       <?php } ?>
