                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                            ...
                                            <div class="page-controls-sorting">
                                                <div class="dropdown">
                                                    <button enabled="false" class="btn sorting-btn dropdown-toggle" type="button" data-toggle="dropdown">Ürünler</button>
                                            ...
                                            <div class="single-item-list">
                                                ...
                                                <div class="item-content">
                                                    <div class="item-info">
                                                        ...
                                                        <div class="price"><?php echo $uruncek['urun_fiyat'] ?> <span style="font-size:12px;">₺</span></div>
